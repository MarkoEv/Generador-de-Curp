  ...
  <div class="swiper mySwiper w-full h-[60%]" hidden>
    ...
    <div class="swiper-slide text-center  text-2xl dark:bg-black/80 ">
      ...
      <div class="text-gray-950 dark:text-white p-5"></div>
          <div class="flex flex-col items-center justify-center gap-5 lg:justify-items-center lg:items-center lg:gap-0 lg:grid lg: md:justify-items-center md:items-center md:gap-0 md:grid md:">
            <input id="days" type="number" placeholder="Día" min="1" max="31"
              class="lg:text-3xl md:text-2xl text-lg w-40 lg:w-80 md:w-60 h-15 md:h-20 lg:h-20 bg-blue-800 text-white dark:bg-white/5 border rounded-xl md:rounded-2xl lg:rounded-3xl  text-center">
      ...
      <div class="swiper-slide text-center text-2xl dark:bg-black/80 flex justify-center items-center" id="botones">
        <div class="grid text-blue-700 dark:text-white p-5">Género</div>
        <button
      ...
      <div class="swiper-slide text-2xl dark:bg-black/80 text-center flex justify-center items-center">
        <div class="grid text-center justify-center justify-items-center gap-5">
          ...
          <button id="numberRand" class="btn border rounded-2xl  text-white bg-green-600 dark:bg-white w-50 md:w-50 lg:w-70 h-15 md:h-20 lg:h-20 dark:text-gray-900 lg:text-3xl md:text-2xl text-lg">
